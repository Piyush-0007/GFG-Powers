...
function showCase(cases) {
    ...
    chrome.runtime.sendMessage(payload, function (resultData) {
        ...
        const htmlContent = `
                ...
                <textarea class="problems_custom_input_textarea__T9IDk" height="3rem" rows="3" tabindex="1">${data}</textarea>
        ...
        textareaValue = document.querySelector(".problems_custom_input_textarea__T9IDk")
        textareaValue.focus();
